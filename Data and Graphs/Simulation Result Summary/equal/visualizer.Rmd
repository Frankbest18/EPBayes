...
#par(mfrow = c(1,1))
par(xpd = NA)
legend('topright', c('1D_NPMLE', '2D_NPMLE', 'Welch', 'B_F', 'Pooled_t_test', 'EV_NPMLE'), col=c('blue', 'black', 'green', 'pink', 'red', 'darkblue'), pch = c(0,1,2,5,6,7), lwd=2, lty = 1, cex = 1.3, inset = c(-0.8, -1.512))
dev.off()
```

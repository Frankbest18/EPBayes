...
#par(mfrow = c(1,1))
par(xpd = NA)
legend('topright', c('1D_NPMLE', '2D_NPMLE', 'Welch', 'B_F', 'Pooled_t_test', 'EV_NPMLE'), col=c('blue', 'black', 'green', 'pink', 'red','#87CEFA'), pch = c(0,1,2,5,6,3), lwd=2, lty = 1, cex = 1.5, inset = c(-0.5, -2.66))
dev.off()
```
